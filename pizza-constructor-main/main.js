...
$('#bounce').click(function(){
    ...
    $('.warp1').css('display','flex');
    $('.warp1').css('transition','');
});
$('.Oplata').click(function(){
    alert('Оплачено. Сума оплати :'+ summary + currency)
...
// $('#chosseSixe1').click(function () {
//     $('.corg1').fadeToggle(speedHide);
//     $('#chosseSixe').fadeToggle(speedHide);
//     summary += 25;
//     $(".total").html('Оплатити: ' + summary + currency);
// });
// $('#chosseSixe2').click(function () {
//     $('.chosseSixe2').fadeToggle(speedHide);
//     $('#chosse').fadeToggle(speedHide);
//     summary += 25;
//     $(".total").html('Оплатити: ' + summary + currency);
// });
// $('#chosseSixe').click(function () {
//     $('.corg1').fadeToggle(speedHide);
//     $('#chosseSixe').fadeToggle(speedHide);
//     summary -= 25;
//     $(".total").html('Оплатити: ' + summary + currency);
